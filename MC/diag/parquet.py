...
import itertools,sys,os,unittest,argparse,inspect
from nullspace import rank, nullspace
...
if __name__=="__main__":
    parser = argparse.ArgumentParser("Please input the diagram order")
    parser.add_argument("order", help="Please input the diagram order.", type=int)
    ...
    VerDictSimple, Index2Ver, BuildTree, VerTable=Compress(VerDict, Order)
    ...
    # print BuildTree[4,...]
    # print VerTable
    DiagTable={"BuildTree": BuildTree, "VerTable": VerTable}
    IO.SaveDict("diag_table.txt", "w", DiagTable)
